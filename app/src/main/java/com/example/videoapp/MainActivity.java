...
public class MainActivity extends AppCompatActivity implements Player.EventListener {
    ...
    private void getVimeoUrl() {
        progressBar.setVisibility(View.VISIBLE);
        VimeoExtractor.getInstance().fetchVideoWithURL(getString(R.string.media_url), null, new OnVimeoExtractionListener() {
            @Override
            public void onSuccess(VimeoVideo video) {
                youtubeUrl = video.getStreams().get("360p");
                initializePlayer(youtubeUrl);
            }
